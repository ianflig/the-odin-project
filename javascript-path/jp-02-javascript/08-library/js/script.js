...
class darkMode {
  ...
  init() {
    ...
    if (this.darkModeMql && this.darkModeMql.matches && this.darkmode === null)
      this.enableDarkMode();
  }
...
class ScreenController {
  ...
  bindEvents() {
    this.createBookDialog.addEventListener("close", () => {
      this.createBookDialogReset();
    });
    this.newBookButton.addEventListener("click", () => {
      this.createBookDialogShowModal();
    });
    this.newBookCloseButton.addEventListener("click", () => {
      this.createBookDialogClose();
    });
    this.createBook.addEventListener("submit", (e) => {
      this.clickHandlerCreateBook(e);
    });
    this.allCards.addEventListener("click", (e) => {
      this.clickHandlerStatusBook(e);
    });
    this.deleteBookCloseBtn.addEventListener("click", (e) => {
  ...
  createBookDialogShowModal() {
    this.createBookDialog.showModal();
  }

  createBookDialogClose() {
